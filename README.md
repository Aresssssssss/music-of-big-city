...
## 13. [Анализ рекламных источников мобильной игры](/final_projects/mobile_game_analysis)
### Ализ поведения игроков в зависимости от источника перехода и определение наиболее перспективного рекламного источника.
Используемый стек:
- `Python`
- `Pandas`
- `SciPy`
...
## 14. [Анализ книжной базы данных с помощью SQL-запросов](/final_projects/SQL)
...
## 15. [Анализ результатов А/B-тестирования](/final_projects/AB_test)
